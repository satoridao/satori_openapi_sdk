...
from satori.lib.authentication import hmac_hashing, rsa_signature, ed25519_signature, secp256k1_signature, \
    sign_with_type
...
class API(object):
        ...
        self.session.headers.update(
            {
                ...
                "APIKEY": api_key,
                "X-SAPI-SIGN-TYPE": api_sign_type
            }
        )
    ...
    def sign_request(self, http_method, url_path, payload=None):
        ...
        return self.send_request(http_method, url_path, sign_string)
    ...
    def _get_sign(self, payload):
        return sign_with_type(self.api_sign_type, self.api_secret, payload, self.private_key_pass)
