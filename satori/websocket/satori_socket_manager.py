...
from satori.lib.utils import parse_proxies


class SatoriSocketManager(threading.Thread):
    def __init__(
        self,
        stream_url,
        on_message=None,
    ...
    def send_message(self, message):
        self.logger.debug("Sending message to Satori WebSocket Server: %s", message)
